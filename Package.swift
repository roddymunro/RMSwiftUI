...
let package = Package(
    ...
    products: [
        ...
        .library(name: "RMCloseButton", targets: ["RMCloseButton"]),
        .library(name: "RMDeveloperIntro", targets: ["RMDeveloperIntro"]),
        ...
        .library(name: "RMRangeSlider", targets: ["RMRangeSlider"]),
        ...
        .library(name: "RMSlideshow", targets: ["RMSlideshow"]),
    ...
    targets: [
        ...
        .target(name: "RMCloseButton", dependencies: [.target(name: "RMSwiftUICore")], path: "Sources/Packages/CloseButton"),
        .target(name: "RMDeveloperIntro", dependencies: [.target(name: "RMSwiftUICore")], path: "Sources/Packages/DeveloperIntro"),
        ...
        .target(name: "RMRangeSlider", dependencies: [.target(name: "RMSwiftUICore")], path: "Sources/Packages/RangeSlider"),
        ...
        .target(name: "RMSlideshow", dependencies: [.target(name: "RMSwiftUICore"), .target(name: "RMCloseButton")], path: "Sources/Packages/Slideshow"),
